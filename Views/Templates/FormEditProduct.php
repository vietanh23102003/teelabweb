...
<div class="bg-light">
    <div class="container">
        <form method="POST" action="" enctype="multipart/form-data">
            <h4 class="rounded" style="border-bottom: solid 3px black; color: #E8E8E8; ">
                <div class="mt-2 p-1 bg-main rounded" style="width: 325px; background-color:white; color: black; font-weight: bold;">SỬA THÔNG TIN SẢN PHẨM</div>
            </h4>
            ...
            <div class="form-group">
                ...
                <select name="trandmark" class="form-control">
                    ...
                    <option value="3">Áo gió</option>
                    <option value="4">Áo babyTee</option>
                    <option value="5">Áo croptop</option>
            ...
            <div class="form-group">
                <input style="top: 70%; left: 45%; background-color: black; border: none;" class="btn btn-primary" type="submit" name = "update_product" value="Cập nhật sản phẩm">
            </div>
        </form>
    </div>
</div>

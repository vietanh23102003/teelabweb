...
<div class="bg-light">
    <div class="container">
        <h4 class="rounded" style="border-bottom: solid 3px black; color: #E8E8E8;">
            <div class="mt-2 p-1 bg-main rounded" style="width: 260px; color: black !important; background-color: white; font-size:30px; border: 1px solid black !important;">Tất cả sản phẩm</div>
        </h4>
